...
namespace SmartCRM.Service.Users
{
    public class UserService : IUserService
    {
        ...
        public UserService(SmartCRMDbContext db)
        {
            this.db = db;
        }
        ...
        public IEnumerable<User> GetListByFilter(UserSearchFilter filter)
        {
            ...
            userList = finalQuery.Skip((filter.PageNumber - 1) * filter.PageSize)
        ...
        public User GetDetailsById(int id)
        {
            ...
            filteredListing = db.User.Include(i => i.Contact).FirstOrDefault(d => d.Id == id);
